 ...
 *************************************************************************/
    ...
    public void visitMethodDef(JCMethodDecl tree) {
        ...
        try {
            ...
            chk.validate(tree.typarams, localEnv, Shapes.SHAPE.NOTOK); //javab

            // Check that result type is well-formed.
            if (tree.restype != null && !tree.restype.type.hasTag(VOID))
                chk.validate(tree.restype, localEnv, Shapes.SHAPE.NOTOK); //javab
            ...
            if (tree.recvparam != null) {
                ...
                chk.validate(tree.recvparam, newEnv, Shapes.SHAPE.NOTOK); //javab
            }
    ...
    public void visitVarDef(JCVariableDecl tree) {
        ...
        chk.validate(tree.vartype, env, !isImplicitLambdaParameter, Shapes.SHAPE.NOTOK); //javab
    ...
    public void visitApply(JCMethodInvocation tree) {
        ...
        chk.validate(tree.typeargs, localEnv, Shapes.SHAPE.NOTOK); //javab
    }
    //where
    ...
    public void visitNewClass(final JCNewClass tree) {
        ...
        chk.validate(clazz, localEnv, Shapes.SHAPE.NOTOK); //javab
        if (tree.encl != null) {
    ...
    public void visitNewArray(JCNewArray tree) {
        ...
        if (tree.elemtype != null) {
            ...
            chk.validate(tree.elemtype, localEnv, Shapes.SHAPE.NOTOK); //javab
            owntype = elemtype;
    ...
    public void visitReference(final JCMemberReference that) {
        ...
        try {
            ...
            if (TreeInfo.isStaticSelector(that.expr, names)) {
                ...
                chk.validate(that.expr, env, false, Shapes.SHAPE.OK); //javab
            }
    ...
    public void visitTypeCast(final JCTypeCast tree) {
        ...
        chk.validate(tree.clazz, env, false, Shapes.SHAPE.NOTOK); //javab
        //a fresh environment is required for 292 inference to work properly ---
        //see Infer.instantiatePolymorphicSignatureInstance()
        Env<AttrContext> localEnv = env.dup(tree);
...
//                             Resolve.isStatic(env));//DEBUG
    ...
    private void attribClassBody(Env<AttrContext> env, ClassSymbol c) {
        ...
        if (!c.isAnonymous()) {
            ...
            chk.validate(tree.typarams, env, Shapes.SHAPE.OK); // javab
            chk.validate(tree.extending, env, Shapes.SHAPE.OK); //javab
            chk.validate(tree.implementing, env, Shapes.SHAPE.OK); //javab
        }
